      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid gap-10 mb-14 sm:grid-cols-2 sm:gap-12 sm:mb-20 lg:grid-cols-4">
          ...
          <div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-2 min-[420px]:flex-row">
              ...
              <button type="submit" className="min-h-11 px-4 py-2.5 bg-[#5683da] hover:bg-[#6f98ee] rounded-full text-white transition-colors duration-300 cursor-pointer flex items-center justify-center" aria-label="Subscribe">
