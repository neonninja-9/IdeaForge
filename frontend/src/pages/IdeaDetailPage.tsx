...
export default function IdeaDetailPage() {
  ...
  async function handleShare() {
    ...
    try {
      ...
      try { await navigator.clipboard.writeText(shareUrl); setLinkCopied(true); setTimeout(() => setLinkCopied(false), 2000); } catch { /* ignore */ }
    }
  }
          ...
          <div className="space-y-6">
            ...
            <section className="grid gap-4 md:grid-cols-2">
              <article className="rounded-[24px] border border-rose-100 dark:border-rose-500/20 bg-white dark:bg-[#120F17] p-6 shadow-sm dark:shadow-none transition-colors duration-500">
                ...
                <p className="mt-3 whitespace-pre-wrap text-sm leading-7 text-slate-600 dark:text-slate-300">{idea.problem}</p>
              </article>
              <article className="rounded-[24px] border border-emerald-100 dark:border-emerald-500/20 bg-white dark:bg-[#120F17] p-6 shadow-sm dark:shadow-none transition-colors duration-500">
                ...
                <p className="mt-3 whitespace-pre-wrap text-sm leading-7 text-slate-600 dark:text-slate-300">{idea.solution}</p>
              </article>
            </section>
