...
/* ── Effect Components ── */
import BlurText from "../components/landing-page-effects/blurText";
import SpecularButton from "../components/landing-page-effects/specularButton";
import ScrollFloat from "../components/landing-page-effects/scrollFloat";
import CountUp from "../components/landing-page-effects/countUp";
import AnimatedList from "../components/landing-page-effects/animatedList";
import GradualBlur from "../components/landing-page-effects/gradualBlur";
import FlowingMenu from "../components/landing-page-effects/flowingMenu";
import AccordionGallery from "../components/landing-page-effects/accordilonGalllary";
import ScrollExpand from "../components/landing-page-effects/scrollExpand";
import TiltedCard from "../components/landing-page-effects/titledCard";
import ScrollVelocity from "../components/landing-page-effects/scrollVelocity";

const DepthCarousel = lazy(() => import("../components/landing-page-effects/depthCarousel"));
const DriftWall = lazy(() => import("../components/landing-page-effects/driftWall"));
