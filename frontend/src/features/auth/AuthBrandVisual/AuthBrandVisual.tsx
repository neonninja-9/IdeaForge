  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="relative h-[240px] sm:h-[280px] w-full flex items-center justify-center">
        ...
        <div className="absolute left-1/2 top-1/2 h-44 w-[85%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-[#fa520f]/15 via-purple-500/20 to-pink-500/15 dark:from-[#fa520f]/20 dark:via-purple-500/25 dark:to-pink-500/15 blur-3xl pointer-events-none" />
