  ...
  return (
    <div className="min-h-screen flex bg-[#f8f9fc] dark:bg-[#030206] dot-grid relative transition-colors duration-300">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative items-center justify-center overflow-hidden">
        ...
        {/* Ambient glow blobs */}
        <div className="absolute top-1/4 left-1/4 h-72 w-72 rounded-full bg-blue-500/15 dark:bg-blue-500/15 blur-[100px] pointer-events-none animate-doodle-float" />
        <div className="absolute bottom-1/4 right-1/4 h-56 w-56 rounded-full bg-pink-500/15 dark:bg-pink-500/15 blur-[80px] pointer-events-none animate-doodle-float" style={{ animationDelay: "2s" }} />
