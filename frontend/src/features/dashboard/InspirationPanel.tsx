...
const inspirations = [
  { title: "Technology", prompt: "What everyday task could AI make simpler?", tone: "from-[#fa520f] to-[#fff8e0]0", icon: Sparkles },
  { title: "Healthcare", prompt: "How could care feel more personal?", tone: "from-emerald-500 to-teal-500", icon: Plus },
  { title: "Education", prompt: "What would make learning more accessible?", tone: "from-amber-400 to-orange-500", icon: Zap },
  { title: "Environment", prompt: "What small habit could create a bigger impact?", tone: "from-sky-500 to-cyan-500", icon: Circle },
  { title: "Finance", prompt: "How can money decisions become less stressful?", tone: "from-fuchsia-500 to-purple-500", icon: ArrowUpRight },
];
