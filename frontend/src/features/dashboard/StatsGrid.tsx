...
const statItems = [
  ...
  { key: "totalVotes", label: "Community signals", detail: "Votes on your ideas", icon: TrendingUp, tint: "bg-[#fffaeb] text-[#fa520f] dark:bg-[#1a1625] dark:text-[#ff8105]", offset: "sm:translate-y-6" },
        ...
        {statItems.map(({ key, label, detail, icon: Icon, tint, offset }) => (
          ...
          >
            <div className="relative z-10 flex items-start justify-between">
              ...
              <span className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{stats[key]}</span>
            </div>
